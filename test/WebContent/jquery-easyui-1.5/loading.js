...
// 计算loading框距离顶部和左部的距离（loading框的宽度为215px，高度为40px）
var _LoadingTop = _PageHeight > 40 ? (_PageHeight - 40) / 2 : 0, _LoadingLeft = _PageWidth > 215 ? (_PageWidth - 215) / 2
		: 0;
// 加载gif地址
var Loadimagerul = baseUrl
		+ "jquery-easyui-1.5/themes/default/images/loading.gif";
...
var _LoadingHtml = '<div id="loadingDiv" style="position:absolute;left:0;width:100%;height:'
		...
		+ 'px; top:'
		+ _LoadingTop
		+ 'px; width:100px;; height: 36px; line-height: 36px; padding-left: 50px; padding-right: 5px; background: #fff url('
		+ Loadimagerul
