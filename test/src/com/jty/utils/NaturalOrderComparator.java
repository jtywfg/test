...
{
    public static final String NULL_OBJECT_STRING = "";
    ...
    public String itemString(T item) {
        if (null == item) {
    ...
    private String itemStringInternal(T item) {
        String s = itemString(item);
        if (null == s) {
            return NULL_OBJECT_STRING;
        }
        return s;
    ...
    {
        String a = itemStringInternal(o1);
        String b = itemStringInternal(o2);
    ...
    {
        String[] strings = new String[] { "1-2", null, "1-02", "1-20", "10-20", "fred", "jane", "pic01",
